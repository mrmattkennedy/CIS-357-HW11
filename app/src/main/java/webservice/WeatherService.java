...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/f9fdec2b7098e788405d586c15f330cb/";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            String urlString = BASE_URL + lat + "," + lon;
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                String temp = current.getString("apparentTemperature");
                ...
                result.putExtra("TEMPERATURE", Double.parseDouble(temp));
